...
Template.newVersion.onCreated(function newVersionOnCreated() {
...
Template.newVersion.onRendered(function() {
	// Initialize tooltips
	this.$('[data-toggle="tooltip"]').tooltip();
  });
  
Template.newVersion.helpers({
	monthlySales(){
